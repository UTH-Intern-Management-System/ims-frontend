...
const CoordinatorLayout = () => {
  ...
  const menuItems = [
    ...
    { name: 'Lịch phỏng vấn', path: '/coordinator/interviews', icon: <Schedule /> },
    { name: 'Chương trình đào tạo', path: '/coordinator/training', icon: <School /> },
    { name: 'Theo dõi hiệu suất', path: '/coordinator/performance', icon: <TrendingUp /> },
  ];
          ...
          <Toolbar>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              <Typography variant="body2">
                Xin chào, {user?.name || 'Coordinator'}
              </Typography>
            </Box>
          </Toolbar>
        </AppBar>
